...
# Interacting With Jinx Ethereum via REST

Jinx Ethereum extends the base functionality of the Cosmos-SDK for querying via REST.
...
Jinx Ethereum supports the Swagger API, which is a specification for describing RESTful APIs.
...
The above link will point towards the Cosmos Hub. To point towards your Jinx Ethereum Endpoint and 
