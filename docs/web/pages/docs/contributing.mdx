...
Jinx Ethereum welcomes contributions to its source code from anyone in the community, 
...
the [Jinx Ethereum Github Issues] first to ensure that your changes align with the project's 
philosophy and to get some early feedback that can make the review and merge process 
smoother for both parties.

It's important that your contributions adhere to Jinx Ethereum's coding guidelines, which 
include:
...
All pull requests will be reviewed based on the Jinx Ethereum's code review guidelines.

Jinx Ethereum also encourages an early pull request approach, where contributors create pull 
...
[GitHub repository]: https://github.com/berachain/jinx
[Jinx Ethereum Github Issues]:https://github.com/berachain/jinx/issues