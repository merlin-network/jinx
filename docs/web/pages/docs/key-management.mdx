...
```sh
jinxd keys add test_key

- address: jinx17l03ze40e9spskexcj928fuy94yxa4dy0t3vx0
  name: test_key
...
`jinxd keys add <name> --recover`

This will prompt you for your 24 word mnemonic phrase.

```sh
jinxd keys add test_key_recover --recover
...
- address: jinx17l03ze40e9spskexcj928fuy94yxa4dy0t3vx0
  ...
  pubkey: '{"@type":"/cosmos.crypto.secp256k1.PubKey","key":"AlvTkLacqevyNZ6hl8ZqhWSzQDppseR07qthbNOsy+nz"}'
  type: local
- address: jinx1t6m9ug59cg9yg2cy2hfx40ew4jyj9w0m9rgmlg
  name: validator
