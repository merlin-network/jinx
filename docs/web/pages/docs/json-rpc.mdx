# Jinx Ethereum JSON-RPC

The Jinx Ethereum API is accessible through JSON-RPC, a lightweight protocol for 
transmitting data over the internet. This protocol enables developers to 
interact with the Jinx Ethereum blockchain and access a wide range of 
functionalities through a simple and standardized interface.

Through the Jinx Ethereum JSON-RPC endpoint, developers can access a variety of 
