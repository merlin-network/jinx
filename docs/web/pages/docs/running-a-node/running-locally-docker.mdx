## Running a Jinx Ethereum Cosmos-SDK with Docker
...
2. Pull the docker image
   ...
   ```sh
   docker image pull <jinx-container-registry>/jinx:latest>
   ```
...
3. Run the container image
   ...
   ```sh
   docker run -p 1317:1317 <jinx-container-registry>/jinx:latest>
   ```
