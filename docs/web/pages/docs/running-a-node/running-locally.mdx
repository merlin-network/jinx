## Running a Local Jinx Ethereum Cosmos-SDK Chain
...
The easiest way to install a Cosmos-SDK Blockchain running Jinx Ethereum is to download a pre-built binary. You can find the latest binaries on the [releases](https://github.com/berachain/jinx/releases) page.

### From Source

**Step 1: Install Golang & Foundry**

Go v1.20+ or higher is required for Jinx Ethereum
...
[Foundry](https://book.getfoundry.sh/getting-started/installation) is required for Jinx Ethereum
...
**Step 2: Get Jinx Ethereum source code**
...
After ensuring dependencies are installed correctly, run the following command to start a local development network.
