...
Jinx Ethereum's unique features rely heavily on its custom precompiled contracts. 
How do precompiled contracts work in Ethereum, and what sets them apart from Jinx Ethereum's implementation?
...
## What is a Precompiled Contract on Jinx Ethereum?

In Jinx Ethereum, a precompiled contract is a custom piece of code that is pre-installed on the chain.
...
This allows a precompiled contract on Jinx Ethereum can be used to run
...
The possibilities of a Jinx Ethereum precompiled contract is only limited by the cosmos-sdk application layer and consensus layer.
For information on how to interact with Jinx Ethereum's precompiled contracts, view the [Precompile Overview](../precompile-overview) section.
