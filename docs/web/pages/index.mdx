...
<div style={{ textAlign: "center" }}>
  <div className="cta-container">
    ...
    <Link className="cta" href="https://www.github.com/berachain/jinx">
      Github
    </Link>
  </div>
  <div style={{ marginTop: "2rem" }} />
  <Link
    href="https://github.com/berachain/jinx/blob/main/eth/LICENSE"
    target="_blank"
    style={{
  ...
  >
    Jinx Ethereum is currently licensed under BUSL-1.1 →
  </Link>
</div>
