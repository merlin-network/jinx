...
func init() {
	proto.RegisterType((*WrappedEthereumTransaction)(nil), "jinx.evm.v1alpha1.WrappedEthereumTransaction")
	proto.RegisterType((*WrappedEthereumTransactionResult)(nil), "jinx.evm.v1alpha1.WrappedEthereumTransactionResult")
}

func init() { proto.RegisterFile("jinx/evm/v1alpha1/tx.proto", fileDescriptor_d8b33d2a2c64400f) }
...
func (c *msgServiceClient) EthTransaction(ctx context.Context, in *WrappedEthereumTransaction, opts ...grpc.CallOption) (*WrappedEthereumTransactionResult, error) {
	...
	err := c.cc.Invoke(ctx, "/jinx.evm.v1alpha1.MsgService/EthTransaction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MsgService_EthTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinx.evm.v1alpha1.MsgService/EthTransaction",
	}
...
var _MsgService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "jinx.evm.v1alpha1.MsgService",
	...
	Metadata: "jinx/evm/v1alpha1/tx.proto",
}
