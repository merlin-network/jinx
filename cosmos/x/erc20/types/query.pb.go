...
func init() {
	proto.RegisterType((*ERC20AddressForCoinDenomRequest)(nil), "jinx.erc20.v1alpha1.ERC20AddressForCoinDenomRequest")
	proto.RegisterType((*ERC20AddressForCoinDenomResponse)(nil), "jinx.erc20.v1alpha1.ERC20AddressForCoinDenomResponse")
	proto.RegisterType((*CoinDenomForERC20AddressRequest)(nil), "jinx.erc20.v1alpha1.CoinDenomForERC20AddressRequest")
	proto.RegisterType((*CoinDenomForERC20AddressResponse)(nil), "jinx.erc20.v1alpha1.CoinDenomForERC20AddressResponse")
}

func init() {
	proto.RegisterFile("jinx/erc20/v1alpha1/query.proto", fileDescriptor_ffd29a6c0ff3273b)
}
...
func (c *queryServiceClient) ERC20AddressForCoinDenom(ctx context.Context, in *ERC20AddressForCoinDenomRequest, opts ...grpc.CallOption) (*ERC20AddressForCoinDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinx.erc20.v1alpha1.QueryService/ERC20AddressForCoinDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) CoinDenomForERC20Address(ctx context.Context, in *CoinDenomForERC20AddressRequest, opts ...grpc.CallOption) (*CoinDenomForERC20AddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/jinx.erc20.v1alpha1.QueryService/CoinDenomForERC20Address", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _QueryService_ERC20AddressForCoinDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinx.erc20.v1alpha1.QueryService/ERC20AddressForCoinDenom",
	}
...
func _QueryService_CoinDenomForERC20Address_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinx.erc20.v1alpha1.QueryService/CoinDenomForERC20Address",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _QueryService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "jinx.erc20.v1alpha1.QueryService",
	...
	Metadata: "jinx/erc20/v1alpha1/query.proto",
}
