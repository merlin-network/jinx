...
func TestJinxERC20(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "cosmos/testing/integration/precompile/jinxerc20:integration")
}
...
var _ = Describe("ERC20", func() {
	Describe("deploy a jinx erc20 and call it from another contract", func() {
		It("should approve and use the transfer from method", func() {
			...
			// Create a jinx erc20 contract from the address.
			tokenAddr, tx, token, err := cbindings.DeployJinxERC20(
			...
			// Call the jinx erc20 contract to set the allowance of the swapper contract.
			...
			// Call the swapper contract to swap the jinx erc20 token from the msg.sender.
			...
			// Call the balance of the swapper contract to check the balance of the jinx erc20 token.
