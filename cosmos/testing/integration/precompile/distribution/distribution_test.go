...
import (
	...
	bindings "pkg.berachain.dev/jinx/contracts/bindings/cosmos/precompile/distribution"
	sbindings "pkg.berachain.dev/jinx/contracts/bindings/cosmos/precompile/staking"
